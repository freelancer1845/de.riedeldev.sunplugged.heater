...
public class Addresses {
	...
	public static final int HEATER_POWER = 3;
	
	public static final int PLC_START = 4;
	public static final int HORN = 5;
	public static final int ORANGE_LIGHT = 6;
	...
	public static final int MAIN_HEATER_THREE_AI = 5;
	public static final int PRE_HEATER_ONE_AI = 6;
	public static final int PRE_HEATER_TWO_AI = 7;// This one is actual missing

	// Digital Inputs
	
	public static final int HEATER_POWER_INPUT = 0;
	public static final int ALARM_DISABLEING_INPUT = 1;
